export const PERMISSION_SCHEMA_VERSION='2026.09.06-pallet-permissions-v3';
export const PERMISSION_KEYS=['codesConsult','codesAssociate','productsEdit','inventoryAdjust','physicalStockAdjust','labelsPrint','mapView','inventoryCount','inventoryManage','inventoryReview','palletsView','palletsOperate','palletsRegister','palletsEdit','palletsDelete','palletsCleanupResidual','changeSku','reconcileErp','applyErpStock','ordersCancel'];
...
export function userPermissions(user,companyId,siteId){
 ...
 ['physicalStockAdjust','labelsPrint','mapView','inventoryCount','inventoryManage','inventoryReview','palletsView','palletsOperate','palletsRegister','palletsEdit','palletsDelete','palletsCleanupResidual','changeSku','reconcileErp','applyErpStock','ordersCancel'].forEach(key=>{if(typeof source[key]!=='boolean')permissions[key]=defaults[key];});
 return permissions;
}
