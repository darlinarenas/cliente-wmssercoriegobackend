export const PERMISSION_SCHEMA_VERSION='2026.09.09-code-quantity-permission-v1';
export const PERMISSION_KEYS=['codesConsult','codesAssociate','codesQuantityAssociate','productsEdit','inventoryAdjust','physicalStockAdjust','labelsPrint','mapView','inventoryCount','inventoryManage','inventoryReview','palletsView','palletsOperate','palletsRegister','palletsEdit','palletsDelete','palletsCleanupResidual','changeSku','reconcileErp','applyErpStock','ordersCancel'];
...
export function userPermissions(user,companyId,siteId){
 ...
 ['codesQuantityAssociate','physicalStockAdjust','labelsPrint','mapView','inventoryCount','inventoryManage','inventoryReview','palletsView','palletsOperate','palletsRegister','palletsEdit','palletsDelete','palletsCleanupResidual','changeSku','reconcileErp','applyErpStock','ordersCancel'].forEach(key=>{if(typeof source[key]!=='boolean')permissions[key]=defaults[key];});
 return permissions;
}

export function requireOperations(...operations){
 const operationPermission={codesAssociate:'codesAssociate',codesQuantityAssociate:'codesQuantityAssociate',productsEdit:'productsEdit',inventoryAdjust:'inventoryAdjust',physicalStockAdjust:'physicalStockAdjust',inventoryCount:'inventoryCount',inventoryManage:'inventoryManage',inventoryReview:'inventoryReview',palletsOperate:'palletsOperate',palletsRegister:'palletsRegister',palletsEdit:'palletsEdit',palletsDelete:'palletsDelete',palletsCleanupResidual:'palletsCleanupResidual'};
 return (req,res,next)=>{
