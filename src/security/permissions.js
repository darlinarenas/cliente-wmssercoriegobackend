...
export function requireOperations(...operations){
 const operationPermission={codesAssociate:'codesAssociate',codesQuantityAssociate:'codesQuantityAssociate',productsEdit:'productsEdit',inventoryAdjust:'inventoryAdjust',physicalStockAdjust:'physicalStockAdjust',initialStockLoad:'initialStockLoad',inventoryCount:'inventoryCount',inventoryManage:'inventoryManage',inventoryReview:'inventoryReview',palletsOperate:'palletsOperate',palletsRegister:'palletsRegister',palletsEdit:'palletsEdit',palletsDelete:'palletsDelete',palletsCleanupResidual:'palletsCleanupResidual'};
 return (req,res,next)=>{
